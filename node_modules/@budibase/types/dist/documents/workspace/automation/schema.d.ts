...
export type ActionImplementations<T extends Hosting> = {
    ...
    [AutomationActionStepId.API_REQUEST]: ActionImplementation<APIRequestStepInputs, APIRequestStepOutputs>;
    ...
    [AutomationActionStepId.CLASSIFY_CONTENT]: ActionImplementation<ClassifyContentStepInputs, ClassifyContentStepOutputs>;
    [AutomationActionStepId.PROMPT_LLM]: ActionImplementation<PromptLLMStepInputs, PromptLLMStepOutputs>;
...
export type APIRequestStep = AutomationStepSchema<AutomationActionStepId.API_REQUEST>;
...
export type ClassifyContentStep = AutomationStepSchema<AutomationActionStepId.CLASSIFY_CONTENT>;
export type PromptLLMStep = AutomationStepSchema<AutomationActionStepId.PROMPT_LLM>;
...
export declare function isWebhookTrigger(step: AutomationStep | AutomationTrigger): step is AppActionTrigger;
export declare function isRowActionTrigger(step: AutomationStep | AutomationTrigger): step is AppActionTrigger;
